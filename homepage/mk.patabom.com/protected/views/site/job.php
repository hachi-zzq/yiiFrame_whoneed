                            ...
                            <ul class="news_list">
                                ...
                                if($objArticle){
                                    foreach($objArticle as $article){
                                        ...
                                        ?>
                                        <li><span class="icon">·&nbsp;</span><a href="/site/jobDetail?id=<?php echo $article['id']?>" title="<?php echo $article['title']?>"><?php echo $article['title']?></a><span class="time"><?php echo date('Y-m-d',strtotime($article['submit_date']))?></span></li>
                                    <?php
                                    }
                                }
                                ?>
