    ...
    <div id="main_footer_index">
        ...
        <div id="main_ny">
            <div class="content" style="padding-bottom:100px;">
                <p class="p_bt">您当前所在位置：<a href="<?php echo $fLink?>">首页</a> >> <a href="<?php echo $tLink?>" class="current">游戏攻略</a></p>
                    ...
                    <div class="news_c p_t10">
                        <div class="news" style="display:block">
                            <ul class="news_list">
                                <?php
                                if($guider){
                                    foreach($guider as $article){
                                        $typeName = Pdw_homepage_type::model()->find("id='{$article['type']}'")->type_name;
                                        ?>
                                        <li><span class="icon">·&nbsp;</span><a href="/site/guiderDetail?id=<?php echo $article['id']?>" title="<?php echo $article['title']?>"><?php echo $article['title']?></a><span class="time"><?php echo date('Y-m-d',strtotime($article['submit_date']))?></span></li>
                                    <?php
                                    }
                                }
                                ?>
