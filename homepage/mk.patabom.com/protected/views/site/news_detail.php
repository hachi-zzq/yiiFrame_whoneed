...
<?php include 'nav.php'?>
        <div id="main_ny">
            <div class="content" style="padding-bottom:100px;">
                <p class="p_bt">您当前所在位置：<a href="/">首页</a> >> <a href="/site/articleList">新闻公告</a> >> <a href="#" class="current">详情</a></p>
                <div class="box m_t12 pad15 m_h500">
                    ...
                    <div class="content_c">
                        <?php
                            $objContent = Pdw_homepage_article_content::model()->find("id='{$objDetail->id}'");
