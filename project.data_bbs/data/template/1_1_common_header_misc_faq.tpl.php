...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1396412451, '1', './data/template/1_1_common_header_misc_faq.tpl.php', './template/default', 'common/header_misc_faq')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1396412451, '1', './data/template/1_1_common_header_misc_faq.tpl.php', './template/default', 'common/header_misc_faq')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1396412451, '1', './data/template/1_1_common_header_misc_faq.tpl.php', './template/default', 'common/header_misc_faq')
;?>
