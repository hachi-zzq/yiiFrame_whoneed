 ...
 */
	...
	class MyController extends CController{
		...
		public $rid;
		public $uid ;
		public $room_number ;//房间号
		public $attention ;
		public $room_owner ;//房间主
		public $Menubar_rows ;
		public $trends_count;
		public $photo_count;
		public $song_count;
		public $video_count;
		public $channel_rows;
		public $activity_rows;
		public $logo_toggle;
		public $room_owner_nickname ;
		public $room_owner_photo ;
		...
		public function init(){
			...
			if($this->userinfo) {
				//登录用户
				$user_row = User_api::get_user_info($this->userinfo->id);
				$this->user_photo = $user_row['photo'] ;
			}
		}
		...
		{
			$userinfo = array();//var_dump(Yii::app()->user->isGuest);
			...
			if(!Yii::app()->user->isGuest)
			{
				...
				if($user_id)
				{
					$userinfo = Admin_user::model()->find("id = $user_id");
					if($userinfo)
					{
