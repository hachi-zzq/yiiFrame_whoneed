...
<HTML><HEAD><TITLE>十分抱歉，您要查看的网页当前已过期，或已被更名或删除！</TITLE><!--STATUS OK-->
<META http-equiv=Content-Type content="text/html; charset=utf-8">
<SCRIPT>window.wpo={start:new Date*1,pid:109,page:'qing'}</SCRIPT>
<link href="<?php echo Yii::app()->params['fore_domain'];?>/css/404.css" type=text/css rel=stylesheet><!--<![endif]-->
...
src="<?php echo Yii::app()->params['fore_domain'];?>/images/notfound.gif" width=520>
...
href="/">网站首页</A> 或<A href="javascript:history.go(-1)">返回出错页</A></P></DIV></DIV></DIV></SECTION><FOOTER 
class="mod-footer mod-cs-footer">
<DIV class="clearfix hidden-box"></DIV>
<DIV class=footer-box>
<DIV class=copy-box><p>Copyright (c) 2013 patabom.com.All Rights Reserved 闽网文[2012]0747-013号 闽ICP备12009280号-14</p></DIV></DIV></FOOTER>
</BODY>
</HTML>