...
jQuery.fn.extend({
    calendar: function(c) {
        ...
        k += "      <a class='prevMonth pngFix'></a><span class='t_date'><span class='currentYearText'><a class='currentYear'>" + e + "</a>\u5e74</span><span class='currentMonthText'><a class='currentMonth'>" + (f + 1) + "</a>\u6708</span></span><a class='nextMonth pngFix'></a>";
        k += "    </div>";
