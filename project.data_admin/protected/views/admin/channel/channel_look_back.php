    ...
    <table class="table" layoutH="118" targetType="dialog" width="100%">
        ...
        ?>
                    <tr>
                        ...
                        <td>
                            <a class="btnSelect" href="javascript:$.bringBack({channel_id:'<?php echo $id?>', channel_name:'<?php echo $channel_name?>', channel_from:'<?php echo $channel_from?>'})" title="查找带回">选择</a>
                        </td>
                    </tr>
        <?php
                }
