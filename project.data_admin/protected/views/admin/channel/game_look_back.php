    ...
    <form rel="pagerForm" method="post" action="<?php echo Yii::app()->request->requestUri?>" onsubmit="return dwzSearch(this, 'dialog');">
        <div class="searchBar">
            <ul class="searchContent">
                <li>
                    <label>游戏名称:</label>
                    <input class="textInput" name="game_name" value="" type="text">
                </li>
...
<div class="pageContent">
    ...
    <table class="table" layoutH="118" targetType="dialog" width="100%">
        <thead>
        <tr>
            <th orderfield="orgName">游戏编号</th>
            <th orderfield="orgNum">游戏名称</th>
            <th orderfield="leader">AppId</th>
            <th width="80">查找带回</th>
        </tr>
        </thead>
        <tbody>
        ...
        ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btnSelect" href="javascript:$.bringBack({id:'<?php echo $appId?>', game_name:'<?php echo $gameName?>', orgNum:'1001'})" title="查找带回">选择</a>
                        </td>
                    </tr>
        <?php
                }
