...
$(function(){
    $("#add_channel_user").on("click",function(){
        ...
        $.get("/admin/channel/ajaxCheckUserExists/username/"+username,function(data){
            data = eval('('+data+')');
...
function form_submit(){
    var url = '/admin/channel/channelUserSave';
    $.ajax({
        "type":"GET",
        "url" :url,
        ...
        success:function(msg){
            ...
            if(msg.statusCode==200){
                ...
                navTab.reload('/admin/channel/addChannelUser/channel_id/<?php echo $channel_id;?>');
            }else{
