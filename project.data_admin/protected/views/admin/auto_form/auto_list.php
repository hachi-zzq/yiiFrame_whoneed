...
//print_r($arrAutoFormOpe);exit;
			...
			if($arrAutoFormOpe['add'] && $arrAutoFormOpe['add'] == 'no'){
				...
				?>
				<li><a class="add" href="/admin/auto_form/auto_add/tid/<?php echo $tid; ?>/type/<?php echo $type; ?><?php echo $strTypeParma; ?>" target="navTab" rel='auto_add'><span>添加</span></a></li>
				<?php
			}
			...
			if($arrAutoFormOpe['update'] && $arrAutoFormOpe['update'] == 'no'){
				...
				?>
				<li><a class="edit" href="/admin/auto_form/auto_edit/tid/<?php echo $tid; ?>/id/{did}" target="navTab" warn="请选择一条数据再进行操作！"><span>修改</span></a></li>
				<?php
			}
