...
<div class="pageContent">
    ...
    <table class="table" width="900" layoutH="138">
        ...
        <tr>
            ...
            <?php if($type == 'inner'){?><th width="150" orderField="accountCert">二次登录率</th><?php } ?>
        ...
        if(isset($all_child) && !empty($all_child)){
            ...
            foreach($all_child as $c){
                ...
                <tr target="sid_user" rel="1">
                    ...
                    $APUR = $c['pay_users']==0?0:round($c['pay_amount']/$c['pay_users'],4);
                    ...
                    <td><?php echo $c['pay_users']?$c['pay_users']:0?></td>
                    <td><?php echo $c['pay_amount']?$c['pay_amount']:0?></td>
                    <td><?php echo $APUR?></td>
                    <?php if($type=='inner') echo '<td>',$c['login_2_nums'],'</td>'?>
                    <?php if($type=='inner') echo '<td>',$loginTwicePer*100,'%</td>'?>
                ...
                $cost_nums +=$cost;
                $login2_nums +=$c['login_2_nums'];
                $pay_users_nums +=$c['pay_users'];
        ...
        <tr>
            ...
            $sumTwicePer = $all_count==0?0:100*round($login_twice_nums/$all_count,4).'%';
