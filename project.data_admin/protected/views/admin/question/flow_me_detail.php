...
<!--            </p>-->
        ...
        <div class="formBar">
            <ul>
                ...
                <?php
                    if($questionDetail['status'] == 0 || $questionDetail['status'] == 2 || $questionDetail['status'] == 3){
                ?>
                        <li><div class="buttonActive"><div class="buttonContent"><button type="submit">回复客服</button></div></div></li>
                <?php
                    }else{
                ?>
