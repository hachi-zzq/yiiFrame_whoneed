...
<div class="pageHeader">
    <form onsubmit="return navTabSearch(this);" action="/admin/question/flowMeList" method="post">
        <div class="searchBar">
            ...
            <div class="subBar">
                <ul>
                    ...
                    <li><a class="button" href="/admin/question/flowMeHighSearch" target="dialog" mask="true" title="查询框"><span>高级检索</span></a></li>
                </ul>
            </div>
        </div>
    </form>
...
<tr target="sid_user" rel="1">
    ...
    <td>
        <a title="问题详情" target="navTab" href="/admin/question/flowMeDetail?id=<?php echo $question['id']?>" class="btnEdit">查看明细</a>
    </td>
</tr>
<?php
        }
